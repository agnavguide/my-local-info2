...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { id: Date.now(), sender: "bot", text: "안녕하세요! 생활 정보 AI 상담원입니다. 무엇을 도와드릴까요?" }
  ]);
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-blue-500 hover:bg-blue-600 text-white rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-105 z-50"
        aria-label="채팅 상담 열기"
      >
        {isOpen ? (
      ...
      >
        ...
        <div className="bg-slate-900 text-white p-4 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-blue-500 rounded-full flex items-center justify-center shrink-0 shadow-inner">
              <span className="text-sm font-bold">AI</span>
            </div>
            <div>
              <div className="font-bold text-[15px]">AI 상담원</div>
        ...
        {/* 채팅창 하단: 질문 리스트 버튼 */}
        <div className="p-3 bg-white border-t border-slate-100 flex flex-col gap-2 shrink-0 max-h-[40%] overflow-y-auto">
